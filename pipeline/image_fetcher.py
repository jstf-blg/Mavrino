...
SEARCH_MAP = {
    ...
    "curved monitor": "ultrawide curved monitor desk setup",
    "monitor":        "computer monitor desk workspace",
    "mechanical keyboard": "mechanical keyboard desk",
    "webcam":         "webcam desk video call",
    "luggage":        "luggage travel suitcase",
    "travel backpack":"travel backpack hiking adventure",
    "backpack":       "backpack travel bag",
    "packing cube":   "packing cubes organized luggage",
    "portable charger":"power bank charging phone",
    "travel pillow":  "travel neck pillow airplane",
    "massage gun":    "massage gun fitness recovery",
    "treadmill":      "treadmill fitness exercise",
    "yoga mat":       "yoga mat exercise fitness",
    "dumbbell":       "dumbbells home gym weights",
    "fitness tracker":"fitness tracker smartwatch wrist",
    "smart scale":    "bathroom scale weighing",
    "camping chair":  "camping chair outdoors campsite",
    "tent":           "camping tent outdoors nature",
    "cooler":         "cooler box outdoor drinks ice",
    "portable grill": "portable barbecue grill outdoor",
    "sleeping bag":   "sleeping bag camping tent",
    "robot vacuum":   "robot vacuum cleaner floor",
    "air purifier":   "air purifier home living room",
    "stick vacuum":   "vacuum cleaner home floor",
    "humidifier":     "humidifier home mist",
    "space heater":   "space heater home warm",
